...
public class Products {
	...
	private String prodCome;  // 商品上货方
	private String prodComeUrl; // 商品上货方的URL
	...
	public String getProdCome() {
		return prodCome;
	}
	public void setProdCome(String prodCome) {
		this.prodCome = prodCome;
	}
	public String getProdComeUrl() {
		return prodComeUrl;
	}
	public void setProdComeUrl(String prodComeUrl) {
		this.prodComeUrl = prodComeUrl;
	}
