...
e.value);h.before(n);h.after(j)})}})(jQuery);if("undefined"===typeof jQuery)throw Error("jquery-confirm requires jQuery");var jconfirm,Jconfirm;
...
String.prototype.endWith=function(b){return null==b||""==b||0==this.length||b.length>this.length?!1:this.substring(this.length-b.length)==b?!0:!1};String.prototype.startWith=function(b){return null==b||""==b||0==this.length||b.length>this.length?!1:this.substr(0,b.length)==b?!0:!1};
